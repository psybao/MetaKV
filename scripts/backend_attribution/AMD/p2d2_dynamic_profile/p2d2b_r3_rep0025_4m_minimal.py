...
# P2D2B-R3 diagnostic-only selection reduction.
# Frozen representations/mappings and kernel algorithms are unchanged.
selected = [
    r for r in selected
    if r["representation_id"] == "REP_0025"
]

print(
    "[P2D2B-R3] FILTERED_SELECTED="
    + ",".join(
        r["representation_id"]
        for r in selected
    ),
