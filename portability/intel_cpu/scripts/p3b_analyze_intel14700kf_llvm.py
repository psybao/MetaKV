...
WORK = Path(r"D:\metakv_results_backup\Intel14700KF_LLVM_P3B_20260902_184657\formal")
...
status_lines = [
    "=" * 120,
    "P3B INTEL X86 MULTITHREAD THROUGHPUT FINAL STATUS",
    "=" * 120,

    "ROLE=MULTITHREAD_THROUGHPUT_VALIDATION",

    "BACKEND=Intel_x86_64_CPU",
