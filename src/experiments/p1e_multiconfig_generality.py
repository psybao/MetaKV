...
# =============================================================================
# P1E — Multi-configuration generality
# =============================================================================
...
OUT = (
    M55
    / "p1_packed_int4"
    / "p1e_multiconfig_generality"
)

OUT.mkdir(parents=True, exist_ok=True)

RAW_CSV = OUT / "p1e_raw_blocks.csv"
SUMMARY_CSV = OUT / "p1e_summary.csv"
SUMMARY_JSON = OUT / "p1e_summary.json"
STATUS_TXT = OUT / "P1E_FINAL_STATUS.txt"
...
print("=" * 110)
print("P1E MULTI-CONFIGURATION PACKED-INT4 GENERALITY")
print("=" * 110)
...
for ci, rep in enumerate(
    ...
    for wi, groups in enumerate(
        ...
        print(
            f"[P1E] workload={wi}/{len(GROUP_COUNTS)} "
            f"groups={groups:,} "
            f"values={values:,}",
            flush=True
        )
...
lines = [
    "P1E MULTI-CONFIGURATION PACKED-INT4 GENERALITY",
    ...
    f"P1E_FINAL_PASS={len(critical)==0}",
]
